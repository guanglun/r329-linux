...
static int zhouyi_v2_enable_clk(struct aipu_core *core)
{
	return 0;
}

static void zhouyi_v2_disable_clk(struct aipu_core *core)
{
}
...
struct aipu_core_operations zhouyi_v2_ops = {
	...
	.enable_clk = zhouyi_v2_enable_clk,
	.disable_clk = zhouyi_v2_disable_clk,
